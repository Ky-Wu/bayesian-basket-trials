...
# N = 19, n1 = 4, r = 1, R1 = 2, alpha2_star = 0.01829471
alpha2_star <- 0.01829471
PPRule <- constructPPRule(R1 = 2, r = 1, alpha2_star)
...
saveRDS(prunepool_res, file.path(getwd(), "output", "fixedss_sim", "prunepool_res.rds"))
